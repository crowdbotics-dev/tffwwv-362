"""
Django settings for tffwwv_362 project.
...
WSGI_APPLICATION = 'tffwwv_362.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tffwwv_362 API",
    "DESCRIPTION": "API documentation for tffwwv_362 App",
    "VERSION": "v1",
}
